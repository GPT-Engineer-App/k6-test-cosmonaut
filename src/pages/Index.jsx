...
const DogBreeds = () => {
  const breeds = [
    ...
    { name: 'French Bulldog', description: 'Playful, smart, and adaptable apartment dogs.' },
    { name: 'Bulldog', description: 'Kind, courageous, and friendly family companions.' },
    { name: 'Poodle', description: 'Very smart and trainable dogs with a playful spirit.' },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-100 to-white p-8">
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-center text-gray-600 mb-8">Your comprehensive guide to canine companions</p>
        </motion.div>
              ...
              <TabsContent value="care">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Learn essential tips to keep your furry friend happy, healthy, and thriving.</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <CareTips />
                  </CardContent>
